...
def check_recovery(num_time_points = 400, noise_perc=10, poly_degree=2, random_seed = 111, wrong_relation_dict={},
                   silent=False):
    ...
    for ind, data_matrix_ in enumerate(data_matrix_df_list):
        ...
        noisy_data_df = add_noise_to_df(data_matrix_, noise_perc=noise_perc, random_seed=random_seed)
    ...
    seq_th_model = sequentialThLin(fit_intercept=True, alpha=0.3, coef_threshold= 0.045, silent=True)
    ...
    if discovered_second_true and discovered_true and not silent:
